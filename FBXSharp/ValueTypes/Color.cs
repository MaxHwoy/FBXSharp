...
namespace FBXSharp.ValueTypes
{
	...
	public struct ColorRGBA
	{
		...
		public static implicit operator Vector4(in ColorRGBA color) => new Vector4(color.R, color.G, color.B, color.A);
	}
	...
	public struct ColorRGB
	{
		...
		public static implicit operator Vector3(in ColorRGB color) => new Vector3(color.R, color.G, color.B);
	}
}
